                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if($product->gambar)
                            <div class="mb-6">
                                ...
                                <img src="{{ asset('storage/' . $product->gambar) }}" alt="{{ $product->nama_produk }}" class="max-w-xs rounded-lg shadow">
                            </div>
                        @endif
                        ...
                        <div class="mb-6">
                            ...
                            >
                            <p class="text-sm text-gray-500 mt-1">Format: JPG, PNG, JPEG. Maksimal 2MB. Kosongkan jika tidak ingin mengganti gambar.</p>
                            @error('gambar')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
