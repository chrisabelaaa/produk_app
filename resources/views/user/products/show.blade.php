                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div class="md:col-span-9">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg mb-4">
                                <span class="text-3xl font-bold text-orange-600">Rp {{ number_format($product->harga, 0, ',', '.') }}</span>
                            </div>
                            ...
                            <div class="flex space-x-4">
                                <a href="{{ route('user.products.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-3 px-6 rounded-lg transition-colors">
                                    ← Kembali
                                </a>
                            </div>
                        </div>
